...
public static class DependencyInjectionExtensions
{
  ...
  public static IServiceCollection AddKrakenarQueries(this IServiceCollection services)
  {
    return services
      ...
      .AddTransient<IQueryHandler<ReadPublishedContent, PublishedContent?>, ReadPublishedContentHandler>()
      ...
      .AddTransient<IQueryHandler<SearchPublishedContents, SearchResults<PublishedContentLocale>>, SearchPublishedContentsHandler>()
