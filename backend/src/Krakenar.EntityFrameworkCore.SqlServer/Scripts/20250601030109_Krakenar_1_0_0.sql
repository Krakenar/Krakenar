...
IF SCHEMA_ID(N'Krakenar') IS NULL EXEC(N'CREATE SCHEMA [Krakenar];');
...
IF SCHEMA_ID(N'Messaging') IS NULL EXEC(N'CREATE SCHEMA [Messaging];');
...
CREATE TABLE [Krakenar].[Realms] (
    ...
    [SecretChangedBy] nvarchar(255) NULL,
    [SecretChangedOn] datetime2 NOT NULL,
    ...
    [RequireConfirmedAccount] bit NOT NULL,
...
CREATE TABLE [Logging].[LogEvents] (
    [LogEventId] bigint NOT NULL IDENTITY,
...
CREATE TABLE [Identity].[Actors] (
    ...
    [Key] nvarchar(255) NOT NULL,
    [RealmId] int NULL,
    [RealmUid] uniqueidentifier NULL,
    [Type] nvarchar(255) NOT NULL,
    [Id] uniqueidentifier NOT NULL,
    ...
    CONSTRAINT [FK_Actors_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Identity].[ApiKeys] (
    ...
    CONSTRAINT [FK_ApiKeys_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Content].[ContentTypes] (
    ...
    CONSTRAINT [FK_ContentTypes_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Localization].[Languages] (
    ...
    CONSTRAINT [FK_Languages_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Identity].[Roles] (
    ...
    CONSTRAINT [FK_Roles_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Messaging].[Senders] (
    ...
    CONSTRAINT [FK_Senders_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Messaging].[Templates] (
    ...
    CONSTRAINT [FK_Templates_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Identity].[Users] (
    ...
    CONSTRAINT [FK_Users_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Content].[Contents] (
    ...
    CONSTRAINT [FK_Contents_ContentTypes_ContentTypeId] FOREIGN KEY ([ContentTypeId]) REFERENCES [Content].[ContentTypes] ([ContentTypeId]) ON DELETE NO ACTION,
    CONSTRAINT [FK_Contents_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Content].[FieldTypes] (
    ...
    [Settings] nvarchar(max) NULL,
    [RelatedContentTypeId] int NULL,
    [RelatedContentTypeUid] uniqueidentifier NULL,
    [StreamId] nvarchar(255) NOT NULL,
    [Version] bigint NOT NULL,
    [CreatedBy] nvarchar(255) NULL,
    [CreatedOn] datetime2 NOT NULL,
    ...
    CONSTRAINT [FK_FieldTypes_ContentTypes_RelatedContentTypeId] FOREIGN KEY ([RelatedContentTypeId]) REFERENCES [Content].[ContentTypes] ([ContentTypeId]) ON DELETE NO ACTION,
    CONSTRAINT [FK_FieldTypes_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Localization].[Dictionaries] (
    ...
    CONSTRAINT [FK_Dictionaries_Languages_LanguageId] FOREIGN KEY ([LanguageId]) REFERENCES [Localization].[Languages] ([LanguageId]) ON DELETE NO ACTION,
    CONSTRAINT [FK_Dictionaries_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Messaging].[Messages] (
    ...
    [SenderPhoneCountryCode] nvarchar(2) NULL,
    [SenderPhoneNumber] nvarchar(20) NULL,
    [SenderPhoneExtension] nvarchar(10) NULL,
    [SenderPhoneE164Formatted] nvarchar(40) NULL,
    [SenderDisplayName] nvarchar(255) NULL,
    [SenderProvider] nvarchar(255) NOT NULL,
    [TemplateId] int NULL,
    [TemplateUid] uniqueidentifier NOT NULL,
    [TemplateUniqueName] nvarchar(255) NOT NULL,
    ...
    CONSTRAINT [FK_Messages_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION,
...
CREATE TABLE [Identity].[OneTimePasswords] (
    ...
    [ValidationSucceededOn] datetime2 NULL,
    [CustomAttributes] nvarchar(max) NULL,
    [StreamId] nvarchar(255) NOT NULL,
    [Version] bigint NOT NULL,
    [CreatedBy] nvarchar(255) NULL,
    ...
    CONSTRAINT [FK_OneTimePasswords_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION,
    CONSTRAINT [FK_OneTimePasswords_Users_UserId] FOREIGN KEY ([UserId]) REFERENCES [Identity].[Users] ([UserId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Identity].[Sessions] (
    ...
    CONSTRAINT [FK_Sessions_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION,
...
CREATE TABLE [Identity].[UserIdentifiers] (
    ...
    CONSTRAINT [FK_UserIdentifiers_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION,
...
CREATE TABLE [Content].[ContentLocales] (
    ...
    CONSTRAINT [FK_ContentLocales_ContentTypes_ContentTypeId] FOREIGN KEY ([ContentTypeId]) REFERENCES [Content].[ContentTypes] ([ContentTypeId]) ON DELETE NO ACTION,
    ...
    CONSTRAINT [FK_ContentLocales_Languages_LanguageId] FOREIGN KEY ([LanguageId]) REFERENCES [Localization].[Languages] ([LanguageId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Content].[FieldDefinitions] (
    ...
    CONSTRAINT [FK_FieldDefinitions_FieldTypes_FieldTypeId] FOREIGN KEY ([FieldTypeId]) REFERENCES [Content].[FieldTypes] ([FieldTypeId]) ON DELETE NO ACTION
);

CREATE TABLE [Localization].[DictionaryEntries] (
    [DictionaryEntryId] int NOT NULL IDENTITY,
...
CREATE TABLE [Content].[PublishedContents] (
    ...
    CONSTRAINT [FK_PublishedContents_ContentTypes_ContentTypeId] FOREIGN KEY ([ContentTypeId]) REFERENCES [Content].[ContentTypes] ([ContentTypeId]) ON DELETE NO ACTION,
    CONSTRAINT [FK_PublishedContents_Contents_ContentId] FOREIGN KEY ([ContentId]) REFERENCES [Content].[Contents] ([ContentId]) ON DELETE NO ACTION,
    CONSTRAINT [FK_PublishedContents_Languages_LanguageId] FOREIGN KEY ([LanguageId]) REFERENCES [Localization].[Languages] ([LanguageId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Content].[FieldIndex] (
    ...
    CONSTRAINT [FK_FieldIndex_Contents_ContentId] FOREIGN KEY ([ContentId]) REFERENCES [Content].[Contents] ([ContentId]) ON DELETE NO ACTION,
    CONSTRAINT [FK_FieldIndex_FieldDefinitions_FieldDefinitionId] FOREIGN KEY ([FieldDefinitionId]) REFERENCES [Content].[FieldDefinitions] ([FieldDefinitionId]) ON DELETE NO ACTION,
    ...
    CONSTRAINT [FK_FieldIndex_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION
);
...
CREATE TABLE [Content].[UniqueIndex] (
    ...
    CONSTRAINT [FK_UniqueIndex_Contents_ContentId] FOREIGN KEY ([ContentId]) REFERENCES [Content].[Contents] ([ContentId]) ON DELETE NO ACTION,
    CONSTRAINT [FK_UniqueIndex_FieldDefinitions_FieldDefinitionId] FOREIGN KEY ([FieldDefinitionId]) REFERENCES [Content].[FieldDefinitions] ([FieldDefinitionId]) ON DELETE NO ACTION,
    ...
    CONSTRAINT [FK_UniqueIndex_Realms_RealmId] FOREIGN KEY ([RealmId]) REFERENCES [Krakenar].[Realms] ([RealmId]) ON DELETE NO ACTION
);
...
CREATE UNIQUE INDEX [IX_Actors_RealmId_Type_Id] ON [Identity].[Actors] ([RealmId], [Type], [Id]) WHERE [RealmId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_ApiKeys_RealmId_Id] ON [Identity].[ApiKeys] ([RealmId], [Id]) WHERE [RealmId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_ContentLocales_ContentId_LanguageId] ON [Content].[ContentLocales] ([ContentId], [LanguageId]) WHERE [LanguageId] IS NOT NULL;

CREATE UNIQUE INDEX [IX_ContentLocales_ContentTypeId_LanguageId_UniqueNameNormalized] ON [Content].[ContentLocales] ([ContentTypeId], [LanguageId], [UniqueNameNormalized]) WHERE [LanguageId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_Contents_RealmId_Id] ON [Content].[Contents] ([RealmId], [Id]) WHERE [RealmId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_ContentTypes_RealmId_Id] ON [Content].[ContentTypes] ([RealmId], [Id]) WHERE [RealmId] IS NOT NULL;

CREATE UNIQUE INDEX [IX_ContentTypes_RealmId_UniqueNameNormalized] ON [Content].[ContentTypes] ([RealmId], [UniqueNameNormalized]) WHERE [RealmId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_Dictionaries_RealmId_Id] ON [Localization].[Dictionaries] ([RealmId], [Id]) WHERE [RealmId] IS NOT NULL;

CREATE UNIQUE INDEX [IX_Dictionaries_RealmId_LanguageId] ON [Localization].[Dictionaries] ([RealmId], [LanguageId]) WHERE [RealmId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_FieldTypes_RealmId_Id] ON [Content].[FieldTypes] ([RealmId], [Id]) WHERE [RealmId] IS NOT NULL;

CREATE UNIQUE INDEX [IX_FieldTypes_RealmId_UniqueNameNormalized] ON [Content].[FieldTypes] ([RealmId], [UniqueNameNormalized]) WHERE [RealmId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_Languages_RealmId_CodeNormalized] ON [Localization].[Languages] ([RealmId], [CodeNormalized]) WHERE [RealmId] IS NOT NULL;

CREATE UNIQUE INDEX [IX_Languages_RealmId_Id] ON [Localization].[Languages] ([RealmId], [Id]) WHERE [RealmId] IS NOT NULL;

CREATE UNIQUE INDEX [IX_Languages_RealmId_LCID] ON [Localization].[Languages] ([RealmId], [LCID]) WHERE [RealmId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_Messages_RealmId_Id] ON [Messaging].[Messages] ([RealmId], [Id]) WHERE [RealmId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_OneTimePasswords_RealmId_Id] ON [Identity].[OneTimePasswords] ([RealmId], [Id]) WHERE [RealmId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_Roles_RealmId_Id] ON [Identity].[Roles] ([RealmId], [Id]) WHERE [RealmId] IS NOT NULL;

CREATE UNIQUE INDEX [IX_Roles_RealmId_UniqueNameNormalized] ON [Identity].[Roles] ([RealmId], [UniqueNameNormalized]) WHERE [RealmId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_Senders_RealmId_Id] ON [Messaging].[Senders] ([RealmId], [Id]) WHERE [RealmId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_Sessions_RealmId_Id] ON [Identity].[Sessions] ([RealmId], [Id]) WHERE [RealmId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_Templates_RealmId_Id] ON [Messaging].[Templates] ([RealmId], [Id]) WHERE [RealmId] IS NOT NULL;

CREATE UNIQUE INDEX [IX_Templates_RealmId_UniqueNameNormalized] ON [Messaging].[Templates] ([RealmId], [UniqueNameNormalized]) WHERE [RealmId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_UniqueIndex_FieldDefinitionId_LanguageId_Status_ValueNormalized] ON [Content].[UniqueIndex] ([FieldDefinitionId], [LanguageId], [Status], [ValueNormalized]) WHERE [LanguageId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_UserIdentifiers_RealmId_Key_Value] ON [Identity].[UserIdentifiers] ([RealmId], [Key], [Value]) WHERE [RealmId] IS NOT NULL;
...
CREATE UNIQUE INDEX [IX_Users_RealmId_Id] ON [Identity].[Users] ([RealmId], [Id]) WHERE [RealmId] IS NOT NULL;

CREATE UNIQUE INDEX [IX_Users_RealmId_UniqueNameNormalized] ON [Identity].[Users] ([RealmId], [UniqueNameNormalized]) WHERE [RealmId] IS NOT NULL;
...
VALUES (N'20250601030109_Krakenar_1_0_0', N'9.0.4');
