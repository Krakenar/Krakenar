...
public class LanguageIdTests
{
  ...
  {
    LanguageId id1 = new(Guid.NewGuid(), RealmId.NewId());
    LanguageId id2 = new(id1.EntityId);
  ...
  {
    LanguageId id = LanguageId.NewId(realmId: null);
  ...
  {
    LanguageId id1 = new(Guid.NewGuid(), RealmId.NewId());
    LanguageId id2 = new(id1.StreamId);
