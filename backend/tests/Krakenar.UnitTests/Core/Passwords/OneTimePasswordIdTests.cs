...
public class OneTimePasswordIdTests
{
  ...
  public void Given_RealmAndEntityId_When_ctor_Then_CorrectIdConstructed(string? realmIdValue)
  {
    ...
    OneTimePasswordId id = new(entityId, realmId);
  ...
  {
    OneTimePasswordId id1 = new(Guid.NewGuid(), RealmId.NewId());
    OneTimePasswordId id2 = new(id1.EntityId);
  ...
  {
    OneTimePasswordId id = OneTimePasswordId.NewId(realmId: null);
  ...
  public void Given_RealmId_When_NewId_Then_NewRandomIdGenerated(string? realmIdValue)
  {
    ...
    OneTimePasswordId id = OneTimePasswordId.NewId(realmId);
