...
public class FieldTypeIdTests
{
  ...
  public void Given_StreamId_When_ctor_Then_CorrectIdConstructed(string? realmIdValue)
  {
    ...
    StreamId streamId = IdHelper.Construct("FieldType", entityId, realmId);

    FieldTypeId id = new(streamId);
  ...
  public void Given_String_When_ctor_Then_CorrectIdConstructed(string? realmIdValue)
  {
    RealmId? realmId = realmIdValue is null ? null : new(realmIdValue);
    Guid entityId = Guid.NewGuid();
    string value = IdHelper.Construct("FieldType", entityId, realmId).Value;

    FieldTypeId id = new(value);
  ...
  public void Given_RealmAndEntityId_When_ctor_Then_CorrectIdConstructed(string? realmIdValue)
  {
    ...
    FieldTypeId id = new(entityId, realmId);
  ...
  {
    FieldTypeId id1 = new(Guid.NewGuid(), RealmId.NewId());
    FieldTypeId id2 = new(id1.EntityId);
  ...
  {
    FieldTypeId id = FieldTypeId.NewId(realmId: null);
  ...
  {
    FieldTypeId id1 = new(Guid.NewGuid(), RealmId.NewId());
    FieldTypeId id2 = new(id1.StreamId);
  ...
  public void Given_RealmId_When_NewId_Then_NewRandomIdGenerated(string? realmIdValue)
  {
    ...
    FieldTypeId id = FieldTypeId.NewId(realmId);
