...
public class MessageIdTests
{
  ...
  public void Given_StreamId_When_ctor_Then_CorrectIdConstructed(string? realmIdValue)
  {
    ...
    StreamId streamId = IdHelper.Construct("Message", entityId, realmId);

    MessageId id = new(streamId);
  ...
  public void Given_RealmAndEntityId_When_ctor_Then_CorrectIdConstructed(string? realmIdValue)
  {
    ...
    MessageId id = new(entityId, realmId);
  ...
  {
    MessageId id1 = new(Guid.NewGuid(), RealmId.NewId());
    MessageId id2 = new(id1.EntityId);
  ...
  {
    MessageId id = MessageId.NewId(realmId: null);
  ...
  {
    MessageId id1 = new(Guid.NewGuid(), RealmId.NewId());
    MessageId id2 = new(id1.StreamId);
  ...
  public void Given_RealmId_When_NewId_Then_NewRandomIdGenerated(string? realmIdValue)
  {
    ...
    MessageId id = MessageId.NewId(realmId);
